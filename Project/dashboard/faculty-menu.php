...
?>
        ...
        <section class="main">
            <div class="sidebar">
                ...
                <form action="../fands/allot.php?<?php echo "fn=$fname&ln=$lname&key=$passwd&id=$erpid&role=$role" ?>" target="_blank" method="POST"><button type="submit">Allot Courses</button></form>
                <form action="../fands/assignment.php?<?php echo "fn=$fname&ln=$lname&key=$passwd&id=$erpid&role=$role" ?>" target="_blank" method="POST"><button type="submit">Assignments</button></form>
                <form action="../fands/takeAtt.php?<?php echo "fn=$fname&ln=$lname&key=$passwd&id=$erpid&role=$role" ?>" target="_blank" method="POST"><button type="submit">Attendence</button></form>
                <form action="../fands/upload_result.php?<?php echo "fn=$fname&ln=$lname&key=$passwd&id=$erpid&role=$role" ?>" target="_blank" method="POST"><button type="submit">Students Result</button></form>
                <!-- <form action="#" method="POST"><button type="submit">Library</button></form> -->
            ...
            <section class="dashRight">
                <form action="../fands/takeAtt.php?<?php echo "fn=$fname&ln=$lname&key=$passwd&id=$erpid&role=$role" ?>" target="_blank" method="POST">
                    <button type="submit">
                ...
                <form action="../fands/assignment.php?<?php echo "fn=$fname&ln=$lname&key=$passwd&id=$erpid&role=$role" ?>" target="_blank" method="POST">
                    <button type="submit">
                ...
                <form action="../fands/upload_result.php?<?php echo "fn=$fname&ln=$lname&key=$passwd&id=$erpid&role=$role" ?>" target="_blank" method="POST">
                    <button type="submit">
        ...
        <div class="accountInfo">
            ...
            <form action="../logout.php?<?php echo "fn=$fname&ln=$lname&key=$passwd&id=$erpid"; ?>" method="POST"><button type="submit">Logout</button></form>
        </div>
