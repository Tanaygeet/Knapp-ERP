...
?>
        ...
        <section class="main">
            <div class="sidebar">
                ...
                <form action="#" method="POST"><button type="submit">All Books</button></form>
                <form action="#" method="POST"><button type="submit">Available Books</button></form>
                <form action="#" method="POST"><button type="submit">Issued Books</button></form>
                <form action="" method="POST"><button type="submit">Add New Books</button></form>
                <form action="" method="POST"><button type="submit">Issue Requests</button></form>
        ...
        <div class="accountInfo">
            ...
            <form action="../display/viewUser.php?<?php echo "fn=$fname&ln=$lname&key=$passwd&id=$erpid&role=$role&location=library-menu.php"; ?>" method="POST"><button type="submit">Profile</button></form>
