...
?>
        ...
        <section class="main">
            <div class="sidebar">
                <form action='../notice/main.php?<?php echo "fn=$fname&ln=$lname&key=$passwd&id=$erpid&role=$role"; ?>' method="POST" target="_blank"><button type="submit">Notices</button></form>
                ...
                <form action='../display/showFaculties.php?<?php echo "fn=$fname&ln=$lname&key=$passwd&id=$erpid&role=$role";?>' target="_blank" method="POST"><button type="submit">Manage Faculties</button></form>
                <button type="submit" class="custBtn staffBtn">Manage Staff</button>
                <form action='../display/showStudents.php?<?php echo "fn=$fname&ln=$lname&key=$passwd&id=$erpid&role=$role";?>' target="_blank" method="POST"><button type="submit">Manage Students</button></form>
                <form action='../display/register.php?<?php echo "fn=$fname&ln=$lname&key=$passwd&id=$erpid&role=$role";?>' target="_blank" method="POST"><button type="submit">Add New</button></form>
            ...
            <section class="dashRight">
                <form action='../display/showFaculties.php?<?php echo "fn=$fname&ln=$lname&key=$passwd&id=$erpid&role=$role";?>' method="POST" target="_blank">
                    <button type="submit">
                ...
                <form action='../display/register.php?<?php echo "fn=$fname&ln=$lname&key=$passwd&id=$erpid&role=$role"; ?>' method="POST" target="_blank">
                    <button type="submit">
                ...
                <form action='../display/showStudents.php?<?php echo "fn=$fname&ln=$lname&key=$passwd&id=$erpid&role=$role";?>' method="POST" target="_blank">
                    <button type="submit">
                ...
                <form action='../display/showStaff.php?<?php echo "fn=$fname&ln=$lname&key=$passwd&id=$erpid&role=$role";?>' method="POST" target="_blank">
                    <button type="submit">
        ...
        <div class="accountInfo">
            ...
            <form action="../display/viewUser.php?<?php echo "fn=$fname&ln=$lname&key=$passwd&id=$erpid&role=$role&location=management-menu.php"; ?>" method="POST"><button type="submit">Profile</button></form>
        ...
        <div class="pop" id="managementPop">
            ...
            <div class="forms">
                ...
                <form action="#" method="POST"><button type="submit">Other Staff</button></form>
            </div>
        </div>
        ...
        <script>
            $(function() {
                ...
                $(".staffBtn").click(function() {
                    $("#managementPop").toggle("slow");
                });
                $(".fa-window-close").click(function() {
                    $("#managementPop").hide("slow");
                });
