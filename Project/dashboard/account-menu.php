...
?>
        ...
        <head>
            ...
            <title>Account Department ERP</title>
        </head>
        ...
        <section class="main">
            <div class="sidebar">
                ...
                <form action="../payments/salary.php?<?php echo "fn=$fname&ln=$lname&key=$passwd&id=$erpid&role=$role" ?>" target="_blank" method="POST"><button type="submit">Faculties Salary</button></form>
                <form action="../payments/salaryStaff.php?<?php echo "fn=$fname&ln=$lname&key=$passwd&id=$erpid&role=$role" ?>" target="_blank" method="POST"><button type="submit" id="managementBtn">Staff Salary</button></form>
                <form action="../payments/fees.php?<?php echo "fn=$fname&ln=$lname&key=$passwd&id=$erpid&role=$role" ?>" target="_blank" method="POST"><button type="submit">Students' Fees</button></form>
            ...
            <section class="dashRight">
                <form action="../payments/fees.php?<?php echo "fn=$fname&ln=$lname&key=$passwd&id=$erpid&role=$role" ?>" target="_blank" method="POST">
                    <button type="submit">
                ...
                <form action="../payments/salary.php?<?php echo "fn=$fname&ln=$lname&key=$passwd&id=$erpid&role=$role" ?>" target="_blank" class="extra" method="POST">
                    <button type="submit">
                ...
                <form action="../payments/salaryStaff.php?<?php echo "fn=$fname&ln=$lname&key=$passwd&id=$erpid&role=$role" ?>" target="_blank" method="POST">
                    <button type="submit">
        ...
        <div class="accountInfo">
            ...
            <form action="../display/viewUser.php?<?php echo "fn=$fname&ln=$lname&key=$passwd&id=$erpid&role=$role&location=account-menu.php"; ?>" method="POST"><button type="submit">Profile</button></form>
