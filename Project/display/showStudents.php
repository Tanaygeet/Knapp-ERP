                            ...
                            <tbody>
                                ...
                                if (mysqli_num_rows($run4) > 0) {
                                    ...
                                    while ($row = mysqli_fetch_assoc($run4)) {
                                        ...
                                        <td>$row[degree]</td>
                                        <td>$row[branch]</td>
                                        <td><a href ='../DB/edit.php?fn=$fname&ln=$lname&key=$passwd&id=$erpid&role=$role&uerpid=$row[erpid]&ufn=$row[firstname]&uln=$row[lastname]&uyear=$row[year]&info1=$row[degree]&info2=$row[branch]&uemail=$row[mailid]&umobile=$row[mobile]&location=showStudents'><i class='fas fa-edit'></i></a></td>
                                        <td><a href ='../DB/delete.php?fn=$fname&ln=$lname&key=$passwd&id=$erpid&role=$role&uerpid=$row[erpid]&location=showStudents'><i class='fas fa-trash-alt'></i></a></td>
                                    </tr>";
                                        $no++;
                                    }
                                } else {
