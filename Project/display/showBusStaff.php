...
<body>
    ...
    <section class="main">
        <div class="sidebar">
            ...
            <form action="bus-menu.php?<?php echo "fn=$fname&ln=$lname&key=$passwd&id=$erpid&role=$role"; ?>" target="_blank" method="POST"><button type="submit">Bus Management</button></form>
        </div>
