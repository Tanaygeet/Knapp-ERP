...
?>
        ...
        <head>
            ...
            <title><?php echo "$fname $lname Account"; ?></title>
        </head>
                ...
                <section class="regRight">
                    <div class="registrationForm">
                        <div class="form">
                            ...
                            <form action='<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . "?fn=$fname&ln=$lname&key=$passwd&id=$erpid&role=$role&location=$location"; ?>' method="POST" class="imgForm">
                                <span class="imageBox"><img src="../images/download.jpg" alt="User Profile" class="accountImg"></span>
                                <input type="file" name="img" id="img" class="img">
                                <button type="submit" name="imgBtn" id="uploadBtn" hidden>Upload</button>
                            </form>

                            <form action="../display/editUser.php?<?php echo "fn=$fname&ln=$lname&key=$passwd&id=$erpid&role=$role&location=$location"; ?>" method="POST" autocomplete="on">
                                <ul>
                                    <li>ERP Id : <span><b><?php echo $erpid; ?></b></span></li>
                                    <li>Mail Id : <span><b><?php echo $uemail; ?></b></span></li>
                                    <li>Name : <span><b><?php echo "$fname $lname"; ?></b></span></li>
                                    <li>DOB : <span><b><?php echo "$dob"; ?></b></span></li>
                                    <li>Contact No. : <span><b><?php echo $umobile; ?></b></span></li>
                                    <li>Branch : <span><b><?php echo "$degree ($branch)"; ?></b></span></li>
                                    <button id="Formbtn" type="submit"><i class="fas fa-edit"> Edit</i></button>
                            </form>
                        </div>
                    </div>
                    </div>
