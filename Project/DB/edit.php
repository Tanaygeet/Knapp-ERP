            ...
            <section class="main">
                ...
                <section class="regRight">
                    <div class="registrationForm">
                        <div class="form">
                            <form action="../DB/change.php?<?php echo "fn=$fname&ln=$lname&key=$passwd&id=$erpid&role=$role&location=$location"; ?>" method="POST" autocomplete="on">
                                <ul>
                                    <li>ERP Id*
                                        <input type="text" name="uerpid" readonly value="<?php echo $uerpid; ?>" required>
                                    </li>
                                    <li>Mail Id*
                                        <input type="email" name="uemail" autofocus value="<?php echo $uemail; ?>" required>
                                    </li>
                                    <li>
                                        Contact No.*
                                        <input type="text" name="pno" required value="+<?php echo $umobile; ?>" maxlength="13">
                                    </li>
                                    <li>
                                        First Name*
                                        <input type="text" readonly name="fname" value="<?php echo $ufn; ?>" required>
                                    </li>
                                    <li>
                                        Last Name*
                                        <input type="text" readonly name="lname" value="<?php echo $uln; ?>" required>
                                    </li>
                                    <li>
                                        <input disabled hidden type="text" id="upasswd" name="upasswd" readonly value="update@123">
                                    </li>
                                    <li><small style="width: 100%; text-align:center;">For Students and HODs/ HOIs/ Faculties</small></li>
                                    <li>
                                        Degree
                                        <select name="udegree" id="degree">
                                    ...
                                    <li>
                                        <hr style="background: #000; border: solid 1px #000">
                                        <strong>Current : <?php echo "$info1 & $info2"; ?></strong>
                                        <hr style="background: #000; border: solid 1px #000">
                                    </li>
