        ...
        <body>
            ...
            <section class="main">
                ...
                <section class="showContainer">
                    ...
                    <form class="allotForm" action="../DB/allotFee.php?<?php echo "fn=$fname&ln=$lname&key=$passwd&id=$erpid&role=$role"; ?>" method="post">
                        <div class="tableContainer">
                            <nav class="allotment">
                                <label for="sname">Fees To Pay<input required type="number" min="0" name="fee" id="fee" class="field"></label>
                                <label for="sem">Accountant Id<input required type="text" name="fid" id="fid" value="<?php echo $erpid; ?>" class="field" readonly></label>
                            </nav>
                ...
                <span id="lateFee">
                    <form action="../DB/lateFee.php?<?php echo "fn=$fname&ln=$lname&key=$passwd&id=$erpid&role=$role"; ?>" method="POST">
                        <input name='old_fee' value='<?php echo $old_fee; ?>' hidden>
                        <input name='late_fee' type='number' id='lInp' required autofocus>
                        <?php
                        if (isset($_POST["filter"])) {
                            $s1 = $_POST["s1"];
                            $s2 = $_POST["s2"];
                        ...
                        if (mysqli_num_rows($run4) > 0) {
                            ...
                            while ($row = mysqli_fetch_assoc($run4)) {
                                echo "<tr>
                                            <input name='c$cno' value='$cno' hidden>
                                        <input name='stid$cno' value='$row[erpid]' hidden>";
                                $cno++;
                            }
                        }
                        ?>
