...
?>
        ...
        <head>
            ...
            <title><?php echo "$fname $lname"; ?> Payment</title>
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-xl-7 col-lg-8 col-md-9 col-sm-11">
                        <div class="card border-0">
                            ...
                            <form id="form" action="paymentcheck.php?<?php echo "fn=$fname&ln=$lname&key=$passwd&id=$erpid&role=$role&pay=$pay&otp=$otp"; ?>" method="POST">
                                <div class="row">
                                    <div class="col-sm-7 border-line pb-3">
                                        <div class="form-group">
                                            <p class="text-dark text-sm mb-0">Name on the card</p> <input type="text" name="name" id="card-name" placeholder="Name" size="15" autofocus required>
                                        </div>
                                        <div class="form-group">
                                            <p class="text-dark text-sm mb-0">Card Nuber</p>
                                        ...
                                        <div class="form-group">
                                            <p class="text-dark text-sm mb-0">Expiry date</p> <input type="text" name="exp" id="card-exp" placeholder="MM/YY" size="6" id="exp" minlength="5" maxlength="5" required>
                                        </div>
                                        <div class="form-group">
